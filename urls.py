...
from .views import (
    ...
    BlogListView, IncrementHabitCounter, CompleteTaskView,
    privacy_policy, terms_of_service, ResendActivationView,
    RegistrationSuccessView, ActivateAccountView, activation_sent, 
    FeedbackView, BlogDetailView, FaqView
)
...
urlpatterns = [
     ...
     path('journal/entry/create/', JournalEntryCreateView.as_view(),
          name='new_entry'),
     path('list/', JournalEntryListView.as_view(),
          name='entry_list'),  # Fixed missing slash
     path('entry/<int:pk>/', JournalEntryDetailView.as_view(),
          name='entry_detail'),
     ...
     path('forum/<int:pk>/delete/', ForumDeleteView.as_view(),
          name='post_delete'),
     ...
     path('habits/<int:pk>/update/', HabitUpdateView.as_view(),
          name='habit_update'),
     path('increment-habit-counter/<int:pk>/', IncrementHabitCounter.as_view(),
          name='increment_habit_counter'),
     ...
     path('complete-todo/<int:todo_id>/', CompleteToDoView.as_view(),
          name='complete_todo'),
     ...
     path('blog/', BlogListView.as_view(), name='blog_list'),
         # Assuming you have a BlogDetailView
