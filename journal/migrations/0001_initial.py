        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "avatar_top",
                    models.CharField(
                        default="/static/virtual_try_on/garmets/tops/1.png",
                        max_length=255,
                    ),
                ),
                (
                    "avatar_bottom",
                    models.CharField(
                        default="/static/virtual_try_on/garmets/skirts/1.png",
                        max_length=255,
                    ),
                ),
                (
                    "avatar_shoes",
                    models.CharField(
                        default="/static/virtual_try_on/garmets/shoes/1.png",
                        max_length=255,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "timestamp",
                    models.DateTimeField(
                        default=datetime.datetime(2024, 7, 17, 7, 14, 52, 532307)
                    ),
                ),
                (
                    "reminder_frequency",
