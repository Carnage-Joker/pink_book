...
urlpatterns = [
    ...
    path('equip_item/<int:item_id>/', views.equip_item_ajax, name='equip_item'),
    path('inventory/', views.inventory_view, name='inventory'),    path(
        'unequip/<int:item_id>/', views.unequip_item, name='unequip_item'),
